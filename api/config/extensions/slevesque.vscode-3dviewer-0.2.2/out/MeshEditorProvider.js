...
exports.MeshEditorProvider = void 0;
 ...
 */
class MeshEditorDocument extends dispose_1.Disposable {
    constructor(uri) {
        super();
 ...
 */
let MeshEditorProvider = /** @class */ (() => {
    class MeshEditorProvider {
        ...
        static register(context) {
            return vscode.window.registerCustomEditorProvider(MeshEditorProvider.viewType, new MeshEditorProvider(context), {
        ...
        getHtmlForWebview(webview, document) {
            ...
            const styleUri = webview.asWebviewUri(vscode.Uri.file(path.join(this._context.extensionPath, 'media', 'editor', 'css', 'main.css')));
            const themeUri = webview.asWebviewUri(vscode.Uri.file(path.join(this._context.extensionPath, 'media', 'editor', 'css', darkmode ? 'dark.css' : 'light.css')));
...
<body>
    ...
    MeshEditorProvider.viewType = '3dviewer.editor';
    return MeshEditorProvider;
})();
exports.MeshEditorProvider = MeshEditorProvider;
/**
 * Tracks all webviews.
 */
...
//# sourceMappingURL=MeshEditorProvider.js.map